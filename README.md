...
2. Restart ComfyUI
3. Add node: `Tektite Video Combiner 6.0`

## Notes
- This package intentionally uses a different backend class (`TektiteVideoCombiner6`) so it can live next to older versions.
